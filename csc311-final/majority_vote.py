...
def main():
    ...
    """
    # Load the train data.
    train_data = load_train_csv("../../PycharmProjects/temp/data")
    ...
    valid_data = load_valid_csv("../../PycharmProjects/temp/data")
    predictions = []
    ...
    private_test = load_private_test_csv("../../PycharmProjects/temp/data")
    predictions = []
