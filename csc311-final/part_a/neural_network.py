...
def main():
    ...
    lr = 0.001  # ! this is not 0.001
    num_epoch = 250
    lamb = 0  # dont want regularization right now
    ...
    # without regularizer, the best hyperparameters is k=200, lr = 0.001

    # plt.title(f'Neural Network Validation Accuracy (with regularizer) (lr={lr}; k={k})')
    # plt.xlabel('Epoch')
    ...
    #     plt.plot(epochs_list, val_accs, label=f'lambda={lamb}')
